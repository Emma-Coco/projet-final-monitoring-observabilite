"""Structured logging configuration for Order Service.
...
def setup_logger(service_name: str, log_file: str) -> logging.Logger:
    ...
    Args:
        ...
        log_file: path (relative to the container workdir) of the log file,
            e.g. "logs/order.log". The parent directory is created if needed
            so the file exists as soon as the container starts, which lets
            Promtail pick it up immediately.
    """
